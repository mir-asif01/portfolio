...
function Banner() {
    return <>
        <section className="flex flex-col justify-between sm:pb-16 sm:px-20 items-center sm:flex-row sm:justify-stretch">
            <div className="p-10 sm:w-1/3">
                ...
                <div className="flex justify-center items-center gap-5 mt-5">
                    ...
                    <a href=""><FaLinkedin className="text-5xl" /></a>
                    <a href=""><FaFacebook className="text-5xl" /></a>
                    <a href=""><FaTwitter className="text-5xl" /></a>
                </div>
            </div>
            <div className="p-10 sm:w-1/3">
