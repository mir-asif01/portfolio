    ...
    const projectsData = [
        {
            ...
            name: "E REPAIR SHOP",
            img: p1,
            code: "https://github.com/mir-asif01/e_repair_shop-client",
        ...
        },
        {
            ...
            name: "PRO TASK",
            img: p2,
            code: "https://github.com/mir-asif01/pro_task_frontend",
        ...
        },
        {
            ...
            name: "PROJECTILE",
            img: p3,
            code: "https://github.com/mir-asif01/projectile-frontend",
    ...
    return <>
        <section className="p-10 sm:p-32">
            ...
            <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-10">
                {
                    projectsData.map(prj => <Card key={prj.id} prj={prj} />)
                }
            </div>
        </section>
    </>
